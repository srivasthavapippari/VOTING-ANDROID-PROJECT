...
public class Questionnare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add("Yes, a member of Congress");
        list.add("Yes, a member of BJP");
        list.add("Yes, a member of TRS");
        list.add("Yes, a member of TELUGU DESAM");
        list.add("Yes, a member of DMK");
        list.add("Yes, a member of JANA SENA");
        list.add("Yes, a member of BAHUJAN SAMAJ");
        list.add("Yes, a member of COMMUNIST PART OF INDIA");
        list.add("Yes, a member of AAM AADMI PARTY");
        ...
        nextPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Questionnare.this, Questions2.class);
